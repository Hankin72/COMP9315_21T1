...
scp ./intset.c z5216214@grieg.cse.unsw.edu.au:~/Documents/

scp ./intset.source z5216214@grieg.cse.unsw.edu.au:~/Documents/

scp ./running.sh z5216214@grieg.cse.unsw.edu.au:~/Documents/
